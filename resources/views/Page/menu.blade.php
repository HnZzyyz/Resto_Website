                    ...
                    <div class="row">
                        <div class="col-md-6 col-12 mb-2">
                            ...
                            <input type="text" name="id_menu" id="id_menu" class="form-control bg-body-tertiary"
                                placeholder="Masukkan  ID Menu" readonly value="{{ $idmnu }}">
                        </div>
                        <div class="col-md-6 col-12 mb-2">
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            <a href="#" class="btn btn-sm btn-danger bg-gradient px-5">Hapus <i
                                    class="bi-trash"></i></a>
                            <a href="{{ route('menu') }}" class="btn btn-sm btn-success bg-gradient px-5">Batal <i class="bi-x"></i></a>
                    ...
                    <tbody>
                        @foreach ($data as $a)
                            <tr class="align-middle">
                                ...
                                <td>
                                    <a href="menu/edit/{{ $a->id_menu }}" class="btn btn-sm btn-success"><i class="bi-pencil small"></i></a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
